    ...
    */
    static public function crtRegistro()
    {
        if (isset($_POST["registerName"])) {
            ...
            if (
                ...
                $EncriptarPassword=crypt($_POST["registerPassword"],'$2a$07$wedding4AfidelantonioB$');
    ...
    public function ctrIngreso()
    {
        if (isset($_POST["ingresoEmail"])) {
            ...
            $EncriptarPassword=crypt($_POST["ingresoPassword"],'$2a$07$wedding4AfidelantonioB$');
                ...
                if ($CompararToken == $_POST["tokenUsuario"]) {
                    if ($_POST["updatePassword"] != "") {
                        if(preg_match('/^[0-9a-zA-Z]+$/', $_POST["updatePassword"])){
                            $password =crypt($_POST["updatePassword"],'$2a$07$wedding4AfidelantonioB$');;
                        }
                    } else {
